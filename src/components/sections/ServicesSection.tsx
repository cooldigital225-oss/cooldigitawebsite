              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className={`text-[11px] font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-md ${
                    service.pole === 'solutions-digitales' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' :
                    service.pole === 'accompagnement-technique' ? 'bg-amber-50 text-amber-800 border border-amber-100' :
